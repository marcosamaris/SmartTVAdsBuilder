...
public class MontadorNCL {
	//colocando o conteúdo do sample02 para a array média
	public MontadorNCL(String caminho[],int tipo){
		File arq = new File("C:/Users/Andrei/Documents/TCC_2/Samples/Sample02.txt"); //local do código ncl
		String Media[] = new String[53]; //array com número de linhas do media
	...
	public void AlterarCaminho(String Media[], String Caminho[],int tipo){
		...
		if(tipo==3){
			//tamanho e cor da fonte dos botões
			//botão 1
	...
	//método para escrever no novo arquivo sample02
